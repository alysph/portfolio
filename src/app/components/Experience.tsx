...
const experiences = [
  {
    ...
    tasks: [
      ...
      "Gestión de trazabilidad y calidad de datos: limpieza de archivos de información, conciliación de lotes y generación de reportes y listados de producción.",
      ...
      "Desarrollo de aplicativos y scripts para automatización de procesos, incluyendo bitácora web interna fullstack.",
  ...
  },
  {
    ...
    tasks: [
      "Generación de bases para impresión de folios en distintos tipos de cédulas electorales mediante VBA",
  ...
  },
  {
    ...
    tasks: [
      "Desarrollo de aplicativo para tratamiento de archivos y permisos de circulación",
